...
class threeplayer extends StatefulWidget {
  const threeplayer({super.key});

  @override
  State<threeplayer> createState() => _threeplayerState();
}

class _threeplayerState extends State<threeplayer> with SingleTickerProviderStateMixin {
