...
class _fourplayerState extends State<fourplayer> with SingleTickerProviderStateMixin {
  ...
  void next_turn()
  {
    ...
    {
      if(green_2_position==57&&blue_2_position==57&&yellow_2_position==57&&red_2_position==57)
        {
          if(green_3_position==57&&red_3_position==57&&blue_3_position==57&&yellow_3_position==57)
              {
                if(green_4_position==57&&yellow_4_position==57&&red_4_position==57&&blue_4_position==57)
                  {turn='white';}
    ...
    else
    {
      if(turn=='red')
      {
          ...
          else 
          {
            ...
            {
              if(green_1_position!=57||green_2_position!=57||green_3_position!=57||green_4_position!=57)
              {
                turn="green";
              }
              else{
