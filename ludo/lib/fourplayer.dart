  ...
  void red_animation(int a)
{
  ...
  {
    six_counter=0;
    if(((blue_position[0]==57&&blue_position[1]==57&&blue_position[2]==57&&blue_position[3]==57)||green_position[0]==57&&green_position[1]==57&&green_position[2]==57&&green_position[3]==57)||(red_position[0]==57&&red_position[1]==57&&red_position[2]==57&&red_position[3]==57)||(yellow_position[0]==57&&yellow_position[1]==57&&yellow_position[2]==57&&yellow_position[3]==57))
    {turn='white';}
    else
    {
      if(turn=='red')
